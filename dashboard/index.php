...
<?php
// Assuming you have established a database connection
$pageTitle = "Data Pembayaran Santri";
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            ...
                                                            <div class="col-4 text-right"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; inset: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                                                                <canvas id="update-chart-4" height="50" width="45" style="display: block; width: 45px; height: 50px;"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card bg-c-pink update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            ...
                                                            <div class="col-4 text-right"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; inset: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                                                                <canvas id="update-chart-3" height="50" width="45" style="display: block; width: 45px; height: 50px;"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card bg-c-yellow update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            ...
                                                            <div class="col-4 text-right"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; inset: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                                                                <canvas id="update-chart-1" height="50" width="45" style="display: block; width: 45px; height: 50px;"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card bg-c-green update-card">
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            ...
                                                            <div class="col-4 text-right"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; inset: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                                                                <canvas id="update-chart-2" height="50" width="45" style="display: block; width: 45px; height: 50px;"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="basic-btn" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $query = "SELECT s.*, t.status_transaksi AS status_transaksi, t.nominal AS nominal, k.nama AS nama_kelas FROM santri s LEFT JOIN transaksi t ON s.id_santri = t.id_santri JOIN kelas k ON s.id_kelas = k.id_kelas";
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        ?>
                                                                        <tr>
                                                                            <td colspan="9" class="text-center" style="color: red;">Belum ada data
                                                                                transaksi
                                                                            </td>
                                                                        </tr>
                                                                    <?php
