...
if (isset($_POST['delete_class'])) {
    ...
    if (!empty($classId)) {
        ...
        echo "<script>alert('ID Kelas Invalid');</script>";
    }
}
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="kelas_update.php?id=<?php echo $row['id_kelas']; ?>" class="btn btn-primary shadow sharp me-1">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <form method="post" action="">
                                                            <input type="hidden" name="class_id" value="<?php echo $row['id_kelas']; ?>">
                                                            <button type="submit" name="delete_class" class="btn btn-danger shadow sharp" onclick="return confirm('Apakah anda yakin ingin mengapus kelas ini ?');">
